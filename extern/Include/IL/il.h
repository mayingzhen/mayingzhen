...
#define IL_PVR			0x0440
#define IL_ATC			0x0441
#define IL_KTX			0x0442
...
#define IL_DXT_DONT_DECOMP	0x0727

//pvr definitions
#define IL_PVRTC_FORMAT     0x0728
#define IL_PVRTCRGB2		0x0729
#define IL_PVRTCRGBA2		0x0730
#define IL_PVRTCRGB4	    0x0731
#define IL_PVRTCRGBA4       0x0732

//etc definitions
#define IL_ETC_FORMAT       0x0733

//atc definitions
#define IL_ATC_FORMAT       0x0734
#define IL_ATCI_FORMAT		0x0735
#define IL_ATCA_FORMAT		0x0736
...
#define IL_IMAGE_PVR_ADDBORDER      0x0E00
...
#define C3_DDS_NOT_DECOMPRESS //dds数据不解压
#define IL_C3_DXT_FFORMAT			0x0726
#define IL_C3_DXT_DATA_LEN			0x0727 
...
ILAPI ILboolean ILAPIENTRY ilHasMipMap();
...
/**** Begin adding by linghuye *****************************************************************************/
ILAPI ILboolean ILAPIENTRY ilMakeMngAnimFile(const ILstring FileName, ILint nWidth, ILint nHeight, ILint nFrames, ILvoid ** pFrameImageDatas, ILint nTick);
ILAPI ILvoid ILAPIENTRY ilSetPixelsAlphaTest(ILint XOff, ILint YOff, ILuint Width, ILuint Height, ILenum Format, ILenum Type, ILvoid* Data);
ILAPI ILvoid ILAPIENTRY ilSetPixelsAlphaBlend(ILint XOff, ILint YOff, ILuint Width, ILuint Height, ILenum Format, ILenum Type, ILvoid* Data);
ILAPI ILvoid ILAPIENTRY ilSetEtcDecompress(ILboolean bDecompress);
/**** End adding by linghuye *****************************************************************************/
