...
ILAPI ILvoid ILAPIENTRY iluSetPixelsAlphaTest(ILint XOff, ILint YOff, ILuint Width, ILuint Height, ILenum Format, ILenum Type, ILvoid* Data);
ILAPI ILvoid ILAPIENTRY iluSetPixelsAlphaBlend(ILint XOff, ILint YOff, ILuint Width, ILuint Height, ILenum Format, ILenum Type, ILvoid* Data);
