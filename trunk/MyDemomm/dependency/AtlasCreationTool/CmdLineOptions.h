...
public:
    ...
    const char *  GetArgument(eCmdLineOptionType option, int n)   const;
    int     GetNumFilenames()                               const;
    void    GetFilename(int i, char const **ppFilename)     const;

	void	SetOption(eCmdLineOptionType option);
	void    SetOption(eCmdLineOptionType option,const std::vector<std::string> vValue);
	void	SetFileNames(const std::vector<std::string>& fileNames) {mpFilenames = fileNames;}
...
private:
    struct CmdLineOption 
    {
		...
		std::vector<std::string> pStartArgs;
    };
...
private:
   ...
   // char * const *  mpFilenames;
	std::vector<std::string> mpFilenames;
};
