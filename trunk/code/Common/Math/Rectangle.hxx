...
void Rectangle::combine(const Rectangle& r1, const Rectangle& r2, Rectangle* dst)
{
	...
	dst->x = Math::Min(r1.x, r2.x);
    dst->y = Math::Min(r1.y, r2.y);
    dst->width = Math::Max(r1.x + r1.width, r2.x + r2.width) - dst->x;
    dst->height = Math::Max(r1.y + r1.height, r2.y + r2.height) - dst->y;
}
