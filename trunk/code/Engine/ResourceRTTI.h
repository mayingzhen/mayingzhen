...
#include "Engine/IRenderDevice/IRenderDevice.h"
...
namespace ma
{
	...
	void ResourceRegisterInit()
	{
		...
		ResourceSystem::RegisterResourceFactory("pvr",TextureData_Creator);
		ResourceSystem::RegisterResourceFactory("pkm",TextureData_Creator);
