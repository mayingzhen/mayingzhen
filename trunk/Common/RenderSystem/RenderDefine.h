...
struct COMMON_API VertexElement
{
    short           Stream;
    short           Offset;
    DECL_TYPE       Type;
...
struct COMMON_API SamplerState
{
...
----------------------------------------------------------
*/
// struct COMMON_API eSmaaType : public IEnumObj
// {
// 	enum enum_t {
// 		SMAA_NONE,
// 		SMAA_LOW,
...
----------------------------------------------------------
*/
struct COMMON_API DeviceProperty
{
