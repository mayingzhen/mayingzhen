...
namespace ma
{
	...
	struct FRAMEWORK_API ScriptSignalKey
	{
	...
	struct FRAMEWORK_API ScriptEventBinderKey
	{
		int		m_sender;
		std::string m_signal;
	...
	class FRAMEWORK_API ScriptEventBinder
	{
	protected:
	...
	class FRAMEWORK_API ScriptEventFactory
	{
	public:
	...
	class FRAMEWORK_API DefaultScriptEventFactory : public ScriptEventFactory
	{
	...
	struct FRAMEWORK_API ScriptEventAgent
	{
