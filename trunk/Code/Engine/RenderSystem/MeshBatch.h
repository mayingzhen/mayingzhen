 ...
 */
class MeshBatch /*: public Renderer*/
{
public:
     ...
     * @script{create}
     */
    static MeshBatch* create(VertexDeclaration* vertexFormat, PRIMITIVE_TYPE primitiveType, const char* materialPath, bool indexed, unsigned int initialCapacity = 1024, unsigned int growSize = 1024);
     ...
     * @script{create}
     */
    static MeshBatch* create(VertexDeclaration* vertexFormat, PRIMITIVE_TYPE primitiveType, Material* material, bool indexed, unsigned int initialCapacity = 1024, unsigned int growSize = 1024);
...
public:
     ...
     * Constructor.
     */
    MeshBatch(VertexDeclaration* vertexFormat, PRIMITIVE_TYPE primitiveType, Material* material, bool indexed, unsigned int initialCapacity, unsigned int growSize);
