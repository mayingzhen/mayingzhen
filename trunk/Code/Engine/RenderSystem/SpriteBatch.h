...
public:
     ...
     * @script{create}
     */
    static SpriteBatch* create(const char* texturePath, Technique* effect = NULL, unsigned int initialCapacity = 0);
     ...
     * @script{create}
     */
    static SpriteBatch* create(Texture* texture, Technique* effect = NULL, unsigned int initialCapacity = 0);
