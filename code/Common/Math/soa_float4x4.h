...
OZZ_INLINE ma::SoaFloat4 operator*(const ma::SoaFloat4x4& _m,
                                          const ma::SoaFloat4& _v) {
  const ma::SoaFloat4 ret = {
...
OZZ_INLINE ma::SoaFloat4x4 operator*(const ma::SoaFloat4x4& _a,
                                            const ma::SoaFloat4x4& _b) {
  const ma::SoaFloat4x4 ret = {
