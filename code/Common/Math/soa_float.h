...
OZZ_INLINE ma::SoaFloat4 operator+(const ma::SoaFloat4& _a,
                                          const ma::SoaFloat4& _b) {
  const ma::SoaFloat4 r = {_a.x + _b.x, _a.y + _b.y, _a.z + _b.z,
                                  _a.w + _b.w};
  return r;
}
OZZ_INLINE ma::SoaFloat3 operator+(const ma::SoaFloat3& _a,
                                          const ma::SoaFloat3& _b) {
  const ma::SoaFloat3 r = {_a.x + _b.x, _a.y + _b.y, _a.z + _b.z};
  return r;
}
OZZ_INLINE ma::SoaFloat2 operator+(const ma::SoaFloat2& _a,
                                          const ma::SoaFloat2& _b) {
  const ma::SoaFloat2 r = {_a.x + _b.x, _a.y + _b.y};
  return r;
}
...
OZZ_INLINE ma::SoaFloat4 operator-(const ma::SoaFloat4& _v) {
  const ma::SoaFloat4 r = {-_v.x, -_v.y, -_v.z, -_v.w};
  return r;
}
OZZ_INLINE ma::SoaFloat3 operator-(const ma::SoaFloat3& _v) {
  const ma::SoaFloat3 r = {-_v.x, -_v.y, -_v.z};
  return r;
}
OZZ_INLINE ma::SoaFloat2 operator-(const ma::SoaFloat2& _v) {
  const ma::SoaFloat2 r = {-_v.x, -_v.y};
  return r;
}
...
OZZ_INLINE ma::SoaFloat4 operator*(const ma::SoaFloat4& _a,
                                          ma::_SimdFloat4 _f) {
  const ma::SoaFloat4 r = {_a.x * _f, _a.y * _f, _a.z * _f, _a.w * _f};
  return r;
}
OZZ_INLINE ma::SoaFloat3 operator*(const ma::SoaFloat3& _a,
                                          ma::_SimdFloat4 _f) {
  const ma::SoaFloat3 r = {_a.x * _f, _a.y * _f, _a.z * _f};
  return r;
}
OZZ_INLINE ma::SoaFloat2 operator*(const ma::SoaFloat2& _a,
                                          ma::_SimdFloat4 _f) {
  const ma::SoaFloat2 r = {_a.x * _f, _a.y * _f};
  return r;
}

// Multiplies _a and _b, then adds _addend.
// v = (_a * _b) + _addend
OZZ_INLINE ma::SoaFloat2 MAdd(const ma::SoaFloat2& _a,
                                     const ma::SoaFloat2& _b,
                                     const ma::SoaFloat2& _addend) {
  const ma::SoaFloat2 r = {ma::MAdd(_a.x, _b.x, _addend.x),
                                  ma::MAdd(_a.y, _b.y, _addend.y)};
  return r;
}
OZZ_INLINE ma::SoaFloat3 MAdd(const ma::SoaFloat3& _a,
                                     const ma::SoaFloat3& _b,
                                     const ma::SoaFloat3& _addend) {
  const ma::SoaFloat3 r = {ma::MAdd(_a.x, _b.x, _addend.x),
                                  ma::MAdd(_a.y, _b.y, _addend.y),
                                  ma::MAdd(_a.z, _b.z, _addend.z)};
  return r;
}
OZZ_INLINE ma::SoaFloat4 MAdd(const ma::SoaFloat4& _a,
                                     const ma::SoaFloat4& _b,
                                     const ma::SoaFloat4& _addend) {
  const ma::SoaFloat4 r = {ma::MAdd(_a.x, _b.x, _addend.x),
                                  ma::MAdd(_a.y, _b.y, _addend.y),
                                  ma::MAdd(_a.z, _b.z, _addend.z),
                                  ma::MAdd(_a.w, _b.w, _addend.w)};
  return r;
}
...
OZZ_INLINE ma::SimdInt4 operator<(const ma::SoaFloat4& _a,
                                         const ma::SoaFloat4& _b) {
  const ma::SimdInt4 x = ma::CmpLt(_a.x, _b.x);
  const ma::SimdInt4 y = ma::CmpLt(_a.y, _b.y);
  const ma::SimdInt4 z = ma::CmpLt(_a.z, _b.z);
  const ma::SimdInt4 w = ma::CmpLt(_a.w, _b.w);
  return ma::And(ma::And(ma::And(x, y), z), w);
}
OZZ_INLINE ma::SimdInt4 operator<(const ma::SoaFloat3& _a,
                                         const ma::SoaFloat3& _b) {
  const ma::SimdInt4 x = ma::CmpLt(_a.x, _b.x);
  const ma::SimdInt4 y = ma::CmpLt(_a.y, _b.y);
  const ma::SimdInt4 z = ma::CmpLt(_a.z, _b.z);
  return ma::And(ma::And(x, y), z);
}
OZZ_INLINE ma::SimdInt4 operator<(const ma::SoaFloat2& _a,
                                         const ma::SoaFloat2& _b) {
  const ma::SimdInt4 x = ma::CmpLt(_a.x, _b.x);
  const ma::SimdInt4 y = ma::CmpLt(_a.y, _b.y);
  return ma::And(x, y);
...
OZZ_INLINE ma::SimdInt4 operator<=(const ma::SoaFloat4& _a,
                                          const ma::SoaFloat4& _b) {
  const ma::SimdInt4 x = ma::CmpLe(_a.x, _b.x);
  const ma::SimdInt4 y = ma::CmpLe(_a.y, _b.y);
  const ma::SimdInt4 z = ma::CmpLe(_a.z, _b.z);
  const ma::SimdInt4 w = ma::CmpLe(_a.w, _b.w);
  return ma::And(ma::And(ma::And(x, y), z), w);
}
OZZ_INLINE ma::SimdInt4 operator<=(const ma::SoaFloat3& _a,
                                          const ma::SoaFloat3& _b) {
...
OZZ_INLINE ma::SimdInt4 operator>(const ma::SoaFloat4& _a,
                                         const ma::SoaFloat4& _b) {
  const ma::SimdInt4 x = ma::CmpGt(_a.x, _b.x);
  const ma::SimdInt4 y = ma::CmpGt(_a.y, _b.y);
  const ma::SimdInt4 z = ma::CmpGt(_a.z, _b.z);
  const ma::SimdInt4 w = ma::CmpGt(_a.w, _b.w);
  return ma::And(ma::And(ma::And(x, y), z), w);
}
OZZ_INLINE ma::SimdInt4 operator>(const ma::SoaFloat3& _a,
                                         const ma::SoaFloat3& _b) {
...
OZZ_INLINE ma::SimdInt4 operator>=(const ma::SoaFloat4& _a,
                                          const ma::SoaFloat4& _b) {
  const ma::SimdInt4 x = ma::CmpGe(_a.x, _b.x);
  const ma::SimdInt4 y = ma::CmpGe(_a.y, _b.y);
  const ma::SimdInt4 z = ma::CmpGe(_a.z, _b.z);
  const ma::SimdInt4 w = ma::CmpGe(_a.w, _b.w);
  return ma::And(ma::And(ma::And(x, y), z), w);
}
OZZ_INLINE ma::SimdInt4 operator>=(const ma::SoaFloat3& _a,
                                          const ma::SoaFloat3& _b) {
...
OZZ_INLINE ma::SimdInt4 operator==(const ma::SoaFloat4& _a,
                                          const ma::SoaFloat4& _b) {
  const ma::SimdInt4 x = ma::CmpEq(_a.x, _b.x);
  const ma::SimdInt4 y = ma::CmpEq(_a.y, _b.y);
  const ma::SimdInt4 z = ma::CmpEq(_a.z, _b.z);
  const ma::SimdInt4 w = ma::CmpEq(_a.w, _b.w);
  return ma::And(ma::And(ma::And(x, y), z), w);
}
OZZ_INLINE ma::SimdInt4 operator==(const ma::SoaFloat3& _a,
                                          const ma::SoaFloat3& _b) {
...
OZZ_INLINE ma::SimdInt4 operator!=(const ma::SoaFloat4& _a,
                                          const ma::SoaFloat4& _b) {
  const ma::SimdInt4 x = ma::CmpNe(_a.x, _b.x);
  const ma::SimdInt4 y = ma::CmpNe(_a.y, _b.y);
  const ma::SimdInt4 z = ma::CmpNe(_a.z, _b.z);
  const ma::SimdInt4 w = ma::CmpNe(_a.w, _b.w);
  return ma::Or(ma::Or(ma::Or(x, y), z), w);
}
OZZ_INLINE ma::SimdInt4 operator!=(const ma::SoaFloat3& _a,
                                          const ma::SoaFloat3& _b) {
  const ma::SimdInt4 x = ma::CmpNe(_a.x, _b.x);
