...
//					  VC6 and earlier, whidch generate incorrect code.
...
public:
	...
	void* getThisPointer()const {return m_pthis;}
...
public:
	...
	RetType operator() () const 
	{
		...
		fastdelegate::detail::GenericClass * thisObj = m_Closure.GetClosureThis();
		FastDelegate0::GenericMemFn fn = m_Closure.GetClosureMemPtr();
...
public:
	...
	RetType operator() (Param1 p1) const 
	{
		...
		fastdelegate::detail::GenericClass * thisObj = m_Closure.GetClosureThis();
		FastDelegate1::GenericMemFn fn = m_Closure.GetClosureMemPtr();

		return (thisObj->*fn)(p1); 
	}
	// Implicit conversion to "bool" using the safe_bool idiom
private:
	typedef struct SafeBoolStruct {
...
public:
	...
	RetType operator() (Param1 p1, Param2 p2) const 
	{
		...
		fastdelegate::detail::GenericClass * thisObj = m_Closure.GetClosureThis();
		FastDelegate2::GenericMemFn fn = m_Closure.GetClosureMemPtr();

		return (thisObj->*fn)(p1, p2); 
	}
	// Implicit conversion to "bool" using the safe_bool idiom
private:
	typedef struct SafeBoolStruct {
...
public:
	...
	RetType operator() (Param1 p1, Param2 p2, Param3 p3) const 
	{
		...
		fastdelegate::detail::GenericClass * thisObj = m_Closure.GetClosureThis();
		FastDelegate3::GenericMemFn fn = m_Closure.GetClosureMemPtr();

		return (thisObj->*fn)(p1, p2, p3); 
	}
	// Implicit conversion to "bool" using the safe_bool idiom
private:
	typedef struct SafeBoolStruct {
...
public:
	...
	RetType operator() (Param1 p1, Param2 p2, Param3 p3, Param4 p4) const 
	{
		...
		fastdelegate::detail::GenericClass * thisObj = m_Closure.GetClosureThis();
		FastDelegate4::GenericMemFn fn = m_Closure.GetClosureMemPtr();

		return (thisObj->*fn)(p1, p2, p3, p4);
