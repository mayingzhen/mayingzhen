...
public:
    ...
    /**
     * Stores a copy of the specified Matrix4x4 value in this parameter.
     */
    void SetValue(const Matrix4x4& value);

    /**
     * Stores a pointer/array of Matrix4x4 values in this parameter.
     */
    void SetValue(const Matrix4x4* values, unsigned int count = 1);

    /**
     * Sets the value of this parameter to the specified texture sampler.
     */
    void SetValue(const Sampler* sampler);
     ...
     * @script{ignore}
     */
    void SetValue(const Sampler** samplers, unsigned int count);
     ...
     */
    Sampler* SetValue(const char* texturePath, bool generateMipmaps);
    ...
    /**
     * Stores a Matrix4x4 value in this parameter.
     *
     * @param value The value to set.
     */
    ...
    /**
     * Stores an array of Matrix4x4 values in this parameter.
     *
     * @param values The array of values.
     * @param count The number of values in the array.
     * @param copy True to make a copy of the array in the material parameter, or false
