...
struct A4R4G4B4toR4G4B4A4: public PixelConverter <uint16, uint16, FMTCONVERTERID(PF_A4R4G4B4, PF_R4G4B4A4)>
{
	inline static DstType pixelConvert(SrcType inp)
	{
...
struct R4G4B4A4toA4R4G4B4: public PixelConverter <uint16, uint16, FMTCONVERTERID(PF_R4G4B4A4, PF_A4R4G4B4)>
{
	inline static DstType pixelConvert(SrcType inp)
	{
