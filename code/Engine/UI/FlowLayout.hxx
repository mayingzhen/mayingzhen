...
static FlowLayout* __FlowLayOutInstance;
...
FlowLayout::~FlowLayout()
{
    __FlowLayOutInstance = NULL;
}

FlowLayout* FlowLayout::create()
{
    if (!__FlowLayOutInstance)
    {
        __FlowLayOutInstance = new FlowLayout();
    }
    else
    {
        __FlowLayOutInstance->IncReference();
    }
