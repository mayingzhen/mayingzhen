...
void D3D9Mapping::GetD3DDeclUsage(DECL_USAGE DeclUsage,BYTE& d3dUse,BYTE& index)
{
	index = 0;
    switch (DeclUsage)
    {
    case DU_POSITION:
        d3dUse = D3DDECLUSAGE_POSITION;
		break;

    case DU_BLENDWEIGHT:
        d3dUse = D3DDECLUSAGE_BLENDWEIGHT;
		break;

    case DU_BLENDINDICES:
        d3dUse = D3DDECLUSAGE_BLENDINDICES;
		break;

    case DU_NORMAL:
        d3dUse = D3DDECLUSAGE_NORMAL;
		break;
...
std::string D3D9Mapping::GetD3DErrorString(HRESULT hr)
{
