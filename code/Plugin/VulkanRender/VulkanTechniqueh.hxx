...
// 	void VulkanTechnique::Bind()
// 	{
// 		
// 	}
// 
// 	void VulkanTechnique::UnBind()
// 	{
// 
// 	}
...
// 		{
// 			this->GetShaderProgram()->CommitChanges();
// 		}
	}
	...
	void VulkanTechnique::RT_StreamComplete()
	{
		...
		type_count[2].descriptorCount = 8;

		VkDescriptorPoolCreateInfo descriptor_pool = {};
		descriptor_pool.sType = VK_STRUCTURE_TYPE_DESCRIPTOR_POOL_CREATE_INFO;
		descriptor_pool.pNext = NULL;
		descriptor_pool.maxSets = MAX_SHADER_PARAMETER_GROUPS * 2 + 16;
