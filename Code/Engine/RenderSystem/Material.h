...
namespace ma
{
	...
	public:
		...
		static Material* create(const char* pszPath);

		static Material* create(Technique* effect);
		...
		Technique* GetTechnique() {return mTechqique;}

		void SetTechnique(Technique* pTech) {mTechqique = pTech;}

	protected:
		RenderState mRenderState;

		Technique*	mTechqique;
